...
const HAZE_DUMPER_URL = 'https://raw.githubusercontent.com/frk1/hazedumper/master/csgo.json';

export default async function getOffsets(): Promise<Offsets> {
  const result = await axios.get<Offsets>(HAZE_DUMPER_URL);
